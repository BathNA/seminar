...
seminars = []
seminars.append(["02 Oct 2015", "Euan Spence", "http://people.bath.ac.uk/eas25/", "Bath", None, "Does the Galerkin method converge when applied to the standard second-kind integral equations for the Laplacian on Lipschitz domains?", "Abstracts/abstract_template.txt"])
...
seminars.append(["30 Oct 2015", "Dan Simpson", "", "Bath", None, "Why is scaling up computations for statistical models so hard? A case for constructive kleptomania", "Abstracts/abstract_simpson.txt"])
...
seminars.append(["27 Nov 2015", "Dan Green", "", "Bath", None, "Goal-Oriented Inference: Predicting the future without calculating the past", "Abstracts/abstract_green.txt"])
seminars.append(["04 Dec 2015", "Matthew Parkinson", "", "Bath", "TBC", "Multi-Index Monte Carlo for Uncertainty Quantification", "Abstracts/abstract_parkinson.txt"])
